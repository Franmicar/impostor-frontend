---
name: avatar-frame-design
description: Skill para el diseño de marcos de avatar (Avatar Frames) de Deceptra
---

# Reglas de Diseño de Avatar Frames (Marcos de Avatar)

Este skill define las reglas de diseño oficiales y los estándares de integración técnica para todos los marcos de avatar (avatar frames) del proyecto Deceptra.

## Regla Crítica #1 — El Avatar NUNCA se reduce
El personaje del avatar es el elemento más importante del perfil del usuario.
*   **Prohibido**: Reducir la escala interna de la imagen del avatar para que "quepa" dentro de un marco.
...
*   El diámetro interno útil (el espacio transparente central libre de obstrucciones de este aro) debe estar entre el **95% y 98% del tamaño del avatar** en la interfaz, evitando tapar el rostro/cuerpo del personaje.
...
Un marco no es solo un contorno de color. Debe contener elementos narrativos del tema:
