...
# media__1779719682973.jpg -> mode.png (Control panel)
# media__1779719683048.jpg -> type.png (Gamepad + question mark with brushes)
mappings = {
    "media__1779719682973.jpg": os.path.join(setup_dir, "mode.png"),
    "media__1779719683048.jpg": os.path.join(setup_dir, "type.png")
}
