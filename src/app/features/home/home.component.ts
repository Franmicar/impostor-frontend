  ...
  template: `
    <div class="flex flex-col items-center justify-center min-h-dvh bg-transparent text-textPrimary p-6 relative">
        <div class="absolute top-4 right-4 flex gap-4">
            ...
            <button (click)="openRules()" class="w-10 h-10 rounded-full bg-glass border border-glass-border backdrop-blur-md flex items-center justify-center text-textPrimary hover:bg-white/10 transition-colors active:scale-95 shadow-[0_0_15px_rgb(var(--color-primary)/0.4)]">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" />
              </svg>
            </button>
            <button (click)="openSettings()" class="w-10 h-10 rounded-full bg-glass border border-glass-border backdrop-blur-md flex items-center justify-center text-textPrimary hover:bg-white/10 transition-colors active:scale-95 shadow-[0_0_15px_rgb(var(--color-primary)/0.4)]">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="flex-1 flex flex-col items-center justify-center w-full max-w-md mt-12">
            ...
            <div class="w-full flex gap-4 px-4 flex-col">
                <button 
                    (click)="startGame()"
                    class="w-full py-4 relative group overflow-hidden bg-gradient-to-r from-primary to-secondary text-white rounded-2xl font-bold text-xl shadow-[0_0_30px_rgb(var(--color-secondary)/0.4)] transition-all active:scale-95">
