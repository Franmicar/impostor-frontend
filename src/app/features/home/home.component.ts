  ...
  template: `
    <div class="flex flex-col items-center justify-center min-h-dvh bg-transparent text-slate-50 p-6 relative">
        ...
        <div class="flex-1 flex flex-col items-center justify-center w-full max-w-md mt-12">
            ...
            <h1 class="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary mb-2 drop-shadow-[0_0_20px_rgba(242,13,185,0.4)] text-center tracking-tight pb-4">
