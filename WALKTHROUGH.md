...
### Versión 1.4.0
- **Rebranding (Impostify)**: Actualización completa de la identidad del juego hacia el nombre oficial "Impostify", incluyendo mejoras de la UI visual y renombrado nativo de la app.
